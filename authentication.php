...
$settingsFilename = 'jjkloginSettings.php';
$settingsFile = dirname(__FILE__, $webRootDirOffset+1).DIRECTORY_SEPARATOR.'external_includes'.DIRECTORY_SEPARATOR.$settingsFilename;
